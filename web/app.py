...
def build_app(bot) -> FastAPI:
    app = FastAPI(title="Anonymouse Setup", docs_url=None, redoc_url=None)

    @app.get("/health")
    async def health():
        return {"ok": True, "service": "anonymouse"}
